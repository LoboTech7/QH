    ...
    public partial class InitialSchema : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HousePms", x => new { x.HouseId, x.PmId });
                    table.ForeignKey(
                        name: "FK_HousePms_Houses_HouseId",
                        column: x => x.HouseId,
                        principalTable: "Houses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HousePms_Users_PmId",
                        column: x => x.PmId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BaselineDurationDays = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Tasks_Users_CraftsmanId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClientDecisions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClientDecisions_Houses_HouseId",
                        column: x => x.HouseId,
                        principalTable: "Houses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClientDecisions_Tasks_RelatedTaskId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DelayBuffer = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientDecisions_HouseId",
                table: "ClientDecisions",
                column: "HouseId");

            migrationBuilder.CreateIndex(
                name: "IX_ClientDecisions_RelatedTaskId",
                table: "ClientDecisions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HousePms_PmId",
                table: "HousePms",
                column: "PmId");

            migrationBuilder.CreateIndex(
                name: "IX_Houses_ClientId",
                table: "Houses",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_Items_HouseId",
                table: "Items",
                column: "HouseId");
